...
@section('content')
    <section id="body" class="m-container">
        ...
        <div class="body-layout">
            <div id="aboutus">
                <div id="body-l">
                    <h1>VietCar - Cùng bạn đến mọi hành trình</h1>
                </div>
                <div id="body-r">
                    <p>
        ...
        <div class="body-layout">
            <div id="pic1">
                <img src="https://www.mioto.vn/static/media/aboutus1.4c31a699.png" style="max-width: 1140px" alt="">
            </div>
        </div>
        <div class="body-layout">
            <div id="layout3">
                ...
                <div id="pic">
                    <img src="/upload/slides/pic2.jpg" alt="">
                </div>
            </div>
        </div>
        <div id="special-adv">
            <div class="body-layout">
                <h2 id="vietcarNnums">VietCar và những con số</h2>
                <div class="list-icon">
                    <div class="icon">
                        <div>
